...
async function loadBackendVersion(){
  ...
  try{
    ...
    if(data&&data.version){
      ...
      if(parts[0]<3||(parts[0]===3&&parts[1]<7)){
        showRuntimeWarning(`Backend v${state.backendVersion} is older than required v3.7.0. Core tabs work, but Sticky Notes need backend v3.7.0.`);
      }
    }
...
console.info('MyFinance v16.4 loaded — button freeze hardening + matched UI protection');
