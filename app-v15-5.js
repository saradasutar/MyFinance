...
async function replaceMasterPortfolioData(){
  ...
  try{
    const result=await api('replaceMasterPortfolioData',{});
...
console.info('MyFinance v15.5 loaded — master spreadsheet replacement + FE/BE versions');
init();
