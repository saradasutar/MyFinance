...
function bindEvents(){safeOn(els.utilityDrawerOpenBtn,'click',toggleUtilityDrawer);safeOn(els.utilityDrawerCloseBtn,'click',closeUtilityDrawer);safeOn(els.utilityDrawerScrim,'click',closeUtilityDrawer);safeOn(els.overviewStickyShortcut,'click',()=>openUtilityDrawer('STICKY'));safeOn(els.overviewQuoteShortcut,'click',()=>openUtilityDrawer('QUOTE'));
...
console.info('MyFinance v17.0 loaded — Holdings/Watchlist full-screen focus view');
