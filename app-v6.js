...
function openHoldingDrawer(item){
  ...
  els.drawerContent.innerHTML=`
    ...
    ${item.notes?`<section class="drawer-section"><h3 class="drawer-section-title">Notes</h3><div class="drawer-notes">${escapeHtml(item.notes)}</div></section>`:''}
  `;
